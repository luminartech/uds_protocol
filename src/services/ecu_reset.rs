...
impl WireFormat<'_, Error> for EcuResetRequest {
...
impl SingleValueWireFormat<'_, Error> for EcuResetRequest {}
...
impl WireFormat<'_, Error> for EcuResetResponse {
...
impl SingleValueWireFormat<'_, Error> for EcuResetResponse {}
